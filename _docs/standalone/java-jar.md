...
`--fail-if-multiple-mappings-match`: Flag used to make requests fail if several mappings matches. By default, this flag is disabled and let the requests pass through using the first matching mapping.
