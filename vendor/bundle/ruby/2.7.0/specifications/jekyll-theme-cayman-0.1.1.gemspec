# -*- encoding: utf-8 -*-
# stub: jekyll-theme-cayman 0.1.1 ruby lib

Gem::Specification.new do |s|
  s.name = "jekyll-theme-cayman".freeze
  s.version = "0.1.1"
  ...
  s.date = "2018-04-11"
  s.email = ["opensource+jekyll-theme-cayman@github.com".freeze]
  s.homepage = "https://github.com/pages-themes/cayman".freeze
  s.licenses = ["CC0-1.0".freeze]
  s.rubygems_version = "3.2.22".freeze
  s.summary = "Cayman is a Jekyll theme for GitHub Pages".freeze
