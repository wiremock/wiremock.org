...
```gradle
implementation 'org.wiremock:wiremock-grpc-extension:{{ grpc_extension_version }}'
```
...
<dependency>
    ...
    <version>{{ grpc_extension_version }}</version>
</dependency>
```
...
Download the <a id="wiremock-standalone-download" href="https://repo1.maven.org/maven2/org/wiremock/wiremock-standalone/{{ wiremock_version }}/wiremock-standalone-{{ wiremock_version }}.jar">standalone JAR</a> at version 3.2.0 or above
 and the <a id="wiremock-standalone-download" href="https://repo1.maven.org/maven2/org/wiremock/wiremock-grpc-extension-standalone/{{ grpc_extension_version }}/wiremock-grpc-extension-standalone-{{ grpc_extension_version }}.jar">gRPC extension JAR</a> into your working directory.
...
```bash
java -cp wiremock-standalone-{{ wiremock_version }}.jar:wiremock-grpc-extension-standalone-{{ grpc_extension_version }}.jar \
  wiremock.Run \
  --root-dir wiremock
```
