...
description: Configure WireMock server options including ports, HTTPS, proxying, file locations, logging, and advanced settings for Java applications and standalone mode.
---
