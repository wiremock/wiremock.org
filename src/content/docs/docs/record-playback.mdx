...
description: Record HTTP interactions from real APIs and play them back as WireMock stubs. Learn recording modes, filters, and how to capture and reuse API responses.
---
...
<CloudCallout title="WireMock Cloud" icon="sourcehut">
    WireMock Cloud CLI supports simultaneous multi-API recording with advanced customisation of recorded stubs.<br/>
