...
``` groovy
testImplementation "org.wiremock:4.0.0-beta.15"
```
...
``` scala
libraryDependencies +=
"org.wiremock" % "wiremock" % "4.0.0-beta.15" % Test
```
...
```groovy
testImplementation "org.wiremock:wiremock-standalone:4.0.0-beta.15"
```
