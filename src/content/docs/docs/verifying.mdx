---
title: "Verifying"
description: Verify HTTP requests received by WireMock in your tests. Use request verification, request counting, and journal querying to validate API interactions.
---
...
<CloudCallout title="WireMock Cloud" icon="document">
    Validate your mocks against OpenAPI in WireMock Cloud.<br/>
