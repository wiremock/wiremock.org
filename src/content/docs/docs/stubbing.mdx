---
title: "Stubbing"
description: Configure HTTP response stubs in WireMock using JSON or code. Learn stub priorities, response headers, body content, file serving, and managing stub mappings.
---
...
<CloudCallout title="WireMock Cloud" icon="rocket">
    ...
    [**Try WireMock Cloud >**](https://www.wiremock.io?utm_source=oss-docs&utm_medium=oss-docs&utm_campaign=cloud-callouts-stubbing&utm_id=cloud-callouts&utm_term=cloud-callouts-stubbing)
</CloudCallout>
...
`GET, POST, PUT, QUERY, DELETE, HEAD, TRACE, OPTIONS, GET_OR_HEAD`. You can specify `ANY` if
