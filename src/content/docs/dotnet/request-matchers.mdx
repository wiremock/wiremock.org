...
<CloudCallout title="WireMock Cloud" icon="rocket">
    WireMock Cloud's web-based editor with embedded test tool makes advanced matching setups easy<br/>
...
* [ExactMatcher](https://wiremock.org/docs/dotnet/request-matchers#exact-matcher-exactmatcher)
* [LinqMatcher](https://wiremock.org/docs/dotnet/request-matchers#dynamic-linq-linqmatcher)
* [CSharpCodeMatcher](https://wiremock.org/docs/dotnet/request-matching-csharpcode)
* [FormUrlEncodedMatcher](https://wiremock.org/docs/dotnet/request-matcher-formurlencodedmatcher)
* [GraphQLMatcher](https://wiremock.org/docs/dotnet/request-matching-graphqlmatcher)
* [JsonMatcher](https://wiremock.org/docs/dotnet/request-matching-jsonmatcher)
* [JsonPartialMatcher](https://wiremock.org/docs/dotnet/request-matching-jsonpartialmatcher)
* [JsonPartialWildcardMatcher](https://wiremock.org/docs/dotnet/request-matching-jsonpartialwildcardmatcher)
* [JsonPathMatcher](https://wiremock.org/docs/dotnet/request-matching-jsonpathmatcher)
* [JmesPathMatcher](https://wiremock.org/docs/dotnet/request-matchers#jmes-path-jmespathmatcher)
* [MimePartMatcher](https://wiremock.org/docs/dotnet/request-matching-mimepartmatcher)
* [XPathMatcher](https://wiremock.org/docs/dotnet/request-matchers#xpathmatcher)
* [RegexMatcher](https://wiremock.org/docs/dotnet/request-matchers#regular-expression-matching-regexmatcher)
* [SimMetricsMatcher](https://wiremock.org/docs/dotnet/request-matchers#similarity-metric-matching-simmetricsmatcher)
* [WildcardMatcher](https://wiremock.org/docs/dotnet/request-matchers#wildcardmatching-wildcardmatcher)
* ContentTypeMatcher(🚧)
* [NotNullOrEmptyMatcher](https://wiremock.org/docs/dotnet/request-matchers#notnulloremptymatcher)
* [CustomMatcher](https://wiremock.org/docs/dotnet/request-matchers#custommatcher)
* [ProtoBufMatcher](https://wiremock.org/docs/dotnet/request-matching-protobuf)
