...
Do a GET call to [http://{{wm_hostname}}/__admin/requests](https://wiremock.org/docs/dotnet/admin-api-reference#__adminrequests) to get information about the request you just sent.
