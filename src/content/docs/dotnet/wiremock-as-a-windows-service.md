...
When you start the exe file in Visual Studio or from the commandline, the application will behave same like [WireMock-as a standalone process](https://wiremock.org/docs/dotnet/wiremock-as-a-standalone-process).
