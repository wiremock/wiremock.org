...
<CloudCallout title="WireMock Cloud" icon="rocket">
    ...
    [**Try WireMock Cloud >**](https://www.wiremock.io?utm_source=oss-docs&utm_medium=oss-docs&utm_campaign=cloud-callouts-dotnet-proxying&utm_id=cloud-callouts&utm_term=cloud-callouts-proxying)
</CloudCallout>
...
See also this page for more information on the [ProxyAndRecordSettings](https://wiremock.org/docs/dotnet/settings#proxyandrecordsettings)
