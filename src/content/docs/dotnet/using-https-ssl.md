...
See [WIKI : Settings - Certificate Settings](https://wiremock.org/dotnet/settings#certificatesettings) for details.
...
WireMock.Net will now use this self signed certificate [which can be overridden if you like](https://wiremock.org/dotnet/settings#certificatesettings) to host https urls.
