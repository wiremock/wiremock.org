...
<CloudCallout title="WireMock Cloud" icon="rocket">
    ...
    [**Try WireMock Cloud >**](https://www.wiremock.io?utm_source=oss-docs&utm_medium=oss-docs&utm_campaign=cloud-callouts-dotnet-stubbing&utm_id=cloud-callouts&utm_term=cloud-callouts-stubbing)
</CloudCallout>
...
More details on the json mapping API can be found here : [Admin-API-Reference](https://wiremock.org/docs/dotnet/admin-api-reference).
