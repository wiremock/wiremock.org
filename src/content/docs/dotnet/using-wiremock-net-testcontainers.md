...
Use the following code to get a [RestEase Admin Client](https://wiremock.org/docs/dotnet/admin-api-reference#client-api) for this running container instance.
``` c#
